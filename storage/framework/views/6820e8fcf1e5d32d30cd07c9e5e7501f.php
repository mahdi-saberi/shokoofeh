...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'پنل مدیریت'); ?> - فروشگاه اسباب بازی شکوفه</title>
    ...
    <div class="dashboard-container">
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-header">
                <h2>🧸 پنل مدیریت</h2>
                <p>سلام <?php echo e(auth()->user()->name); ?>!</p>
            </div>
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('admin.age-groups.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.age-groups.*') ? 'active' : ''); ?>">
                            👶 گروه‌های سنی
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo e(route('admin.game-types.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.game-types.*') ? 'active' : ''); ?>">
                            🎮 انواع بازی
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('admin.discounts.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.discounts.*') ? 'active' : ''); ?>">
                            🏷️ تخفیفات
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('admin.site-settings.edit')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.site-settings.*') ? 'active' : ''); ?>">
                            ⚙️ تنظیمات سایت
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item" style="border-top: 1px solid #34495e; margin-top: 1rem; padding-top: 1rem;">
                        <a href="<?php echo e(route('welcome')); ?>" class="nav-link" target="_blank">
                            🌐 مشاهده سایت
                        </a>
                    </li>
                    <li class="nav-item">
