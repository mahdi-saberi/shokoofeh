...
<?php $__env->startSection('content'); ?>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            <div class="stat-number"><?php echo e(format_currency($totalRevenue)); ?></div>
    ...
    <div class="stats-grid-secondary">
        <div class="stat-card-secondary">
            ...
            <div class="stat-content">
                <div class="stat-number"><?php echo e($completedOrders); ?></div>
        ...
        <div class="stat-card-secondary">
            <div class="stat-icon">💰</div>
            <div class="stat-content">
                <div class="stat-number"><?php echo e(format_currency($todayRevenue)); ?></div>
        ...
        <div class="stat-card-secondary">
            <div class="stat-icon">📊</div>
            <div class="stat-content">
                <div class="stat-number"><?php echo e(format_currency($weekRevenue)); ?></div>
        ...
        <div class="stat-card-secondary">
            <div class="stat-icon">🎯</div>
            <div class="stat-content">
                <div class="stat-number"><?php echo e(format_currency($monthRevenue)); ?></div>
    ...
    <div class="stats-grid-secondary">
        ...
        <div class="stat-card-secondary">
            <div class="stat-icon">📈</div>
            <div class="stat-content">
                <div class="stat-number"><?php echo e($weekOrders); ?></div>
        ...
        <div class="stat-card-secondary">
            <div class="stat-icon">📊</div>
            <div class="stat-content">
                <div class="stat-number"><?php echo e($monthOrders); ?></div>
        ...
        <div class="stat-card-secondary">
            <div class="stat-icon">📋</div>
            <div class="stat-content">
                <div class="stat-number"><?php echo e($totalOrders > 0 ? number_format(($completedOrders / $totalOrders) * 100, 1) : 0); ?>%</div>
        ...
        <div class="card-body">
            <?php if($products->count() > 0): ?>
                            ...
                            <tr>
                                <td>
                                    <?php if($product->image): ?>
                                        <img src="<?php echo e(asset('storage/' . $product->image)); ?>" alt="<?php echo e($product->title); ?>" class="table-image">
                                    <?php else: ?>
                                ...
                                <td>
                                    <?php if($product->age_group && count($product->age_group) > 0): ?>
                                        <?php $__currentLoopData = $product->age_group; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $age): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="table-badge age-<?php echo e(($index % 5) + 1); ?>" data-tooltip="گروه سنی: <?php echo e(is_array($age) ? implode(', ', $age) : $age); ?>">
                                                <?php echo e(is_array($age) ? implode(', ', $age) : $age); ?>
                                ...
                                <td>
                                    <?php if(is_array($product->game_type) ? count($product->game_type) > 0 : !empty($product->game_type)): ?>
                                        <?php echo e(is_array($product->game_type) ? implode(', ', $product->game_type) : $product->game_type); ?>
                                ...
                                <td>
                                    <?php if(is_array($product->category) ? count($product->category) > 0 : !empty($product->category)): ?>
                                        <?php if(is_array($product->category)): ?>
                                            <?php echo e(implode(', ', $product->category)); ?>

                                        <?php elseif(is_string($product->category)): ?>
                                            <?php echo e($product->category); ?>

                                        <?php elseif(is_object($product->category)): ?>
                                            <?php echo e($product->category->title ?? 'نامشخص'); ?>
                                ...
                                <td>
                                    <span style="color: #6c757d; font-size: 0.9rem;"><?php echo e(persian_date($product->created_at)); ?></span>
                                </td>
                                <td>
                                    <div class="table-actions">
                                        <a href="<?php echo e(route('admin.products.show', $product->id)); ?>" class="table-btn table-btn-info">👁️ نمایش</a>
                                        <a href="<?php echo e(route('admin.products.edit', $product->id)); ?>" class="table-btn table-btn-warning">✏️ ویرایش</a>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div style="margin-top: 2rem; text-align: center; padding-top: 1.5rem; border-top: 1px solid #e9ecef;">
                    <a href="<?php echo e(route('admin.products.index')); ?>" class="btn btn-primary" style="
                        background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
                        border: none;
                        padding: 12px 30px;
                        border-radius: 25px;
            ...
            <?php else: ?>
                ...
                ">
                    ...
                    <a href="<?php echo e(route('admin.products.create')); ?>" class="btn btn-primary" style="
    ...
    <script>
        ...
        const chartData = <?php echo json_encode($orders, 15, 512) ?>;
