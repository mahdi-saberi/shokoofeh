    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="<?php echo e(route('admin.site-settings.show')); ?>" class="btn btn-outline-info">
                    👁️ پیش‌نمایش
                </a>
            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control"
                                              ...
                                              placeholder="توضیحات کوتاه در مورد سایت..."><?php echo e(old('site_description', $settings->site_description)); ?></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php if($settings->site_logo): ?>
                                        <div>
                                            <img src="<?php echo e($settings->logo_url); ?>" alt="لوگو فعلی" class="logo-preview">
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <label class="form-label d-flex align-items-center">
                                        ...
                                        <label class="switch ms-3">
                                            <input type="checkbox" name="header_announcement_enabled" value="1"
                                                   <?php echo e(old('header_announcement_enabled', $settings->header_announcement_enabled) ? 'checked' : ''); ?>>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control "
                                              ...
                                              placeholder="🎉 ویژه عید نوروز - تخفیف ویژه تمام اسباب بازی‌ها تا ۵۰٪ 🎁"><?php echo e(old('header_announcement_text', $settings->header_announcement_text)); ?></textarea>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="color" class="color-picker "
                                           ...
                                           value="<?php echo e(old('header_announcement_bg_color', $settings->header_announcement_bg_color ?? '#667eea')); ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="color" class="color-picker "
                                           ...
                                           value="<?php echo e(old('header_announcement_text_color', $settings->header_announcement_text_color ?? '#ffffff')); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control "
                                           id="contact_phone" name="contact_phone" value="<?php echo e(old('contact_phone', $settings->contact_phone)); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control "
                                           id="contact_email" name="contact_email" value="<?php echo e(old('contact_email', $settings->contact_email)); ?>"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control "
                                              ...
                                              placeholder="آدرس کامل..."><?php echo e(old('contact_address', $settings->contact_address)); ?></textarea>
                                </div>

                                <div class="form-group">
                                    <label for="working_hours" class="form-label">ساعات کاری</label>
                                    <input type="text" class="form-control "
                                           id="working_hours" name="working_hours" value="<?php echo e(old('working_hours', $settings->working_hours)); ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control "
                                           id="social_telegram" name="social_telegram" value="<?php echo e(old('social_telegram', $settings->social_telegram)); ?>"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control "
                                           id="social_whatsapp" name="social_whatsapp" value="<?php echo e(old('social_whatsapp', $settings->social_whatsapp)); ?>"
                        ...
                        <div class="feature-box-section mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="feature_box_1_enabled" value="1"
                                           <?php echo e(old('feature_box_1_enabled', $settings->feature_box_1_enabled) ? 'checked' : ''); ?>>
                                    <span class="slider"></span>
                                </label>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control "
                                               ...
                                               value="<?php echo e(old('feature_box_1_icon', $settings->feature_box_1_icon)); ?>"
                                               placeholder="🚚">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control "
                                               ...
                                               value="<?php echo e(old('feature_box_1_title', $settings->feature_box_1_title)); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control "
                                          ...
                                          placeholder="برای خریدهای بالای ۵۰۰ هزار تومان در سراسر کشور"><?php echo e(old('feature_box_1_description', $settings->feature_box_1_description)); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="feature-box-section mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="feature_box_2_enabled" value="1"
                                           <?php echo e(old('feature_box_2_enabled', $settings->feature_box_2_enabled) ? 'checked' : ''); ?>>
                                    <span class="slider"></span>
                                </label>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control "
                                               ...
                                               value="<?php echo e(old('feature_box_2_icon', $settings->feature_box_2_icon)); ?>"
                                               placeholder="🔒">
                                        <div class="help-text">می‌توانید از ایموجی یا متن استفاده کنید</div>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control "
                                               ...
                                               value="<?php echo e(old('feature_box_2_title', $settings->feature_box_2_title)); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control "
                                          ...
                                          placeholder="پرداخت آنلاین با بالاترین سطح امنیت"><?php echo e(old('feature_box_2_description', $settings->feature_box_2_description)); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="feature-box-section mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="feature_box_3_enabled" value="1"
                                           <?php echo e(old('feature_box_3_enabled', $settings->feature_box_3_enabled) ? 'checked' : ''); ?>>
                                    <span class="slider"></span>
                                </label>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control "
                                               ...
                                               value="<?php echo e(old('feature_box_3_icon', $settings->feature_box_3_icon)); ?>"
                                               placeholder="🏆">
                                        <div class="help-text">می‌توانید از ایموجی یا متن استفاده کنید</div>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control "
                                               ...
                                               value="<?php echo e(old('feature_box_3_title', $settings->feature_box_3_title)); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control "
                                          ...
                                          placeholder="تمام محصولات دارای گارانتی اصالت و کیفیت"><?php echo e(old('feature_box_3_description', $settings->feature_box_3_description)); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="feature-box-section mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="feature_box_4_enabled" value="1"
                                           <?php echo e(old('feature_box_4_enabled', $settings->feature_box_4_enabled) ? 'checked' : ''); ?>>
                                    <span class="slider"></span>
                                </label>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control "
                                               ...
                                               value="<?php echo e(old('feature_box_4_icon', $settings->feature_box_4_icon)); ?>"
                                               placeholder="📞">
                                        <div class="help-text">می‌توانید از ایموجی یا متن استفاده کنید</div>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control "
                                               ...
                                               value="<?php echo e(old('feature_box_4_title', $settings->feature_box_4_title)); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control "
                                          ...
                                          placeholder="آماده پاسخگویی در تمام ساعات شبانه‌روز"><?php echo e(old('feature_box_4_description', $settings->feature_box_4_description)); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control "
                                              ...
                                              placeholder="متن توضیحی برای فوتر سایت..."><?php echo e(old('footer_text', $settings->footer_text)); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control "
                                              ...
                                              placeholder="اسباب بازی، کودک، لگو، عروسک"><?php echo e(old('meta_keywords', $settings->meta_keywords)); ?></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control "
                                              ...
                                              placeholder="توضیحات مختصری که در نتایج جستجو نمایش داده می‌شود..."><?php echo e(old('meta_description', $settings->meta_description)); ?></textarea>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/site-settings/edit.blade.php ENDPATH**/ ?>