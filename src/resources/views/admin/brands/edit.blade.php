...
<div class="form-container">
    <div class="form-header">
        <h1>✏️ ویرایش برند</h1>
        <p>اطلاعات برند "{{ $brand->title }}" را ویرایش کنید</p>
    </div>
        ...
        <div class="form-group">
            ...
            <div class="file-upload">
                ...
                <label for="logo" class="file-upload-label">
                    ...
                    <span>برای تغییر لوگو کلیک کنید یا فایل جدید را اینجا بکشید</span>
                    <br>
            ...
            <div id="imagePreview" style="display: none;">
                <img id="previewImg" class="preview-image" alt="پیش‌نمایش لوگوی جدید">
            </div>
        </div>
