...
@section('content')
    <div class="header">
        <h1>ویرایش برچسب</h1>
        <p>ویرایش اطلاعات برچسب: {{ $tag->name }}</p>
    </div>

    <div class="card">
        <div class="card-header">
            <h3>فرم ویرایش برچسب</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.tags.update', $tag) }}" method="POST">
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    <div style="display: flex; align-items: center; gap: 1rem;">
                        <input type="color"
                               id="color"
                               name="color"
                               value="{{ old('color', $tag->color ?: '#95a5a6') }}"
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    <textarea id="description"
                              ...
                              placeholder="توضیحات اختیاری درباره این برچسب">{{ old('description', $tag->description) }}</textarea>
                    @error('description')
                        <div style="color: #e74c3c; font-size: 0.9rem; margin-top: 0.25rem;">{{ $message }}</div>
                    @enderror
                </div>
